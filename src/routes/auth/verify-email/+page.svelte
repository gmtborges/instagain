...
{#if form?.error}
	<div class="toast">
		<div class="alert" class:alert-warning={form.level === ToastLevel.Warning}>
...
<div class="bg-white p-4 rounded-lg shadow-md w-full max-w-lg border">
	...
	<p>
		Um código de verificação foi enviado para <strong
			>{data.currentUser.email}</strong
		>.
	</p>
	...
	<form
		...
		<div>
			<label for="code" class="block mb-2 font-medium text-gray-700"
